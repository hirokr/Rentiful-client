...
export const CustomFormField: React.FC<FormFieldProps> = ({
      ...
      case "multiSelect":
        return (
          <Popover>
            ...
            <PopoverContent className='w-full border-gray-200 shadow p-2 space-y-1'>
              {options?.map((option) => {
  ...
  return (
    <FormField
      control={control}
      name={name}
      // Remove defaultValue from here for multiSelect
      ...
      render={({ field }) => (
        ...
        >
          ...
          <FormControl>
            {renderFormControl({
              ...field,
              // For multiSelect, ensure the value is always an array
              value:
                type === "multiSelect"
                  ? Array.isArray(field.value)
                    ? field.value
